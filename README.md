...
**Public extract:** 9,356 rows · **Live catalog:** 9,354 domains
...
- `bar.csv` — public CSV extract (9,356 rows)
- `bar.json` — public JSON extract (9,356 rows)
...
| adept.bar      | available | $81.98    | —             | 92             | 26     | 5      | namecheap |
...
| ----------------------- | ------------------------------------------------ |
| 9,356-row public sample | 9,354 live domains                               |
...
> Unique Domains. *Available .BAR One-Word Domains*. Version 2026-04-13. Public GitHub extract for the exact Unique Domains search represented by this repository.
