# Available .BAR One-Word Domains (9,354)
...
**Public extract:** 9,354 rows · **Live catalog:** 9,354 domains
...
- `bar.csv` — public CSV extract (9,354 rows)
- `bar.json` — public JSON extract (9,354 rows)
...
| actual.bar     | available | $81.98    | —             | 96             | 27     | 6      | namecheap |
...
| ----------------------- | ------------------------------------------------ |
| 9,354-row public sample | 9,354 live domains                               |
...
> Unique Domains. *Available .BAR One-Word Domains*. Version 2026-04-12. Public GitHub extract for the exact Unique Domains search represented by this repository.
