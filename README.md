# Available .BAR One-Word Domains (9,344)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-9%2C350%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-9%2C344%20domains-6f42c1">
...
**Public extract:** 9,350 rows · **Live catalog:** 9,344 domains
...
- `bar.csv` — public CSV extract (9,350 rows)
- `bar.json` — public JSON extract (9,350 rows)
...
| -------------- | --------- | --------- | ------------- | -------------- | ------ | ------ | --------- |
| absolute.bar   | available | $81.98    | —             | 80             | 32     | 8      | namecheap |
| rank.bar       | resell    | $81.98    | —             | 70             | 35     | 4      | GoDaddy   |
...
| adept.bar      | available | $81.98    | —             | 92             | 27     | 5      | namecheap |
...
| free.bar       | premium   | $2,047.50 | $2,925        | 88             | 59     | 4      | namecheap |
| complete.bar   | available | $81.98    | —             | 120            | 26     | 8      | namecheap |
| limitless.bar  | resell    | —         | —             | 76             | 56     | 9      | GoDaddy   |
...
| ----------------------- | ------------------------------------------------ |
| 9,350-row public sample | 9,344 live domains                               |
...
> Unique Domains. *Available .BAR One-Word Domains*. Version 2026-04-10. Public GitHub extract for the exact Unique Domains search represented by this repository.
